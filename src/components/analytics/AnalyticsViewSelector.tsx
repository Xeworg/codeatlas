...
export function AnalyticsViewSelector() {
  ...
  return (
    <div className="flex items-center gap-1 bg-slate-800 border-b border-slate-700 px-3 py-2 flex-shrink-0">
      <span className="text-xs text-slate-500 mr-2 font-semibold uppercase tracking-wide">
        {t('common.view')}
      </span>
      {VIEWS.map((view) => (
        <button
